...
import static org.fasttrackit.genealogicaltree.relationship.SpecificRelation.*;
...
class FamilyGraphTest extends SoftwareTest {
    ...
    private void assertEquals(Person person, Person personById) {
    ...
    private void assertFalse(boolean arePersonsDirectlyConnected) {
    ...
    private void assertEquals(List<ConnectionEdge> expectedConnections, List<ConnectionEdge> shortestRelationChain) {
    ...
    private void assertEquals(Set<ConnectionEdge> expectedConnections, Collection<ConnectionEdge> allMembersFromGenerationLevel) {
    ...
    private void assertEquals(List<Person> expectedOrder, Collection<Person> familyInOrderOfAge) {
    ...
    void getAllPersonByRelation() {
        ...
        assertTrue(persons.containsAll(family.getAllPersonsByRelation(family.getPersonById("6"), GRANDMOTHER, 2)));
    }
    ...
    private void assertEquals(SpecificRelation mother, SpecificRelation genderSpecificRelation) {
