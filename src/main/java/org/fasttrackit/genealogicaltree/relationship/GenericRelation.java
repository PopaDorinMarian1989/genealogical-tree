...
public enum GenericRelation implements Relation {
    ...
    public Object getRelationLevel() {
        return relationLevel;
    }

    public void setRelationLevel(Object relationLevel) {
        this.relationLevel = (int) relationLevel;
    }
    ...
    public SpecificRelation getFemaleRelation() {
        return femaleRelation;
    }

    public void setFemaleRelation(SpecificRelation femaleRelation) {
        this.femaleRelation = femaleRelation;
    }
}
